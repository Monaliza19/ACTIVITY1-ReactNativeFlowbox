...
const Picture = () => {
  return(
    <View>
       <Image source={{ uri: 'https://th.bing.com/th/id/OIP.hQdpoqyrGzkZb-_tHSxGegHaEK?pid=ImgDet&rs=1'}} style ={styles.Picture} />
     </View>
  ) 
};
const BioData = () =>{
  return(
    <View> 
<Text style ={styles.name}> Monaliza R. Liparto </Text>
